...
CRITERIA = {
    "stage2": {
        ...
        "criteria": [
            ("a", "Düşük Karbonlu Alternatif Yakıtların Geliştirilmesi (Yeşil Hidrojen, Biyoyakıtlar, E-Yakıtlar)", "Elektrifikasyonun mümkün olmadığı ulaşım modlarında kullanılmak üzere yeşil hidrojen, biyoyakıtlar ve sentetik e-yakıtlar gibi düşük karbonlu alternatif yakıtların geliştirilmesi ve uygulanması."),
            ("b", "Sürdürülebilir ve Karbonsuz Lojistik Hizmetlerinin Geliştirilmesi", "Yük taşımacılığında karbon emisyonlarının azaltılmasını ve demiryolu–denizyolu–karayolu entegrasyonuyla verimli, multimodal tedarik zinciri yapılarının kurulması."),
            ("c", "Düşük Emisyonlu Taşıtların Satın Alımı / Filo Dönüşümü", "Hidrojen ve elektrikli araçların kamu veya özel filo yapılarında satın alınarak mevcut dizel/benzinli araçların aşamalı biçimde düşük emisyonlu araçlarla değiştirilmesi."),
            ("d", "Sıfır Emisyonlu Alanlar / Park Alanlarının Geliştirilmesi", "LEZ/ULEZ bölgelerinin oluşturulması / artırılması."),
            ("e", "Toplu Taşıma Entegrasyon ve Erişebilirliğin Artırılması", "Farklı ulaşım modları arasında entegrasyonu güçlendiren, güzergâh ve aktarma noktalarında yüksek erişilebilirlik sağlayan altyapı ve işletme çözümleri."),
            ("f", "Aktif Mod ve Paylaşımlı Mobilite Altyapısının Kurulması", "Kentsel ölçekte güvenli ve kesintisiz yürüme–bisiklet altyapısının geliştirilmesi ile paylaşımlı mobilite sistemlerinin (e-scooter, e-bike, paylaşımlı bisiklet vb.) toplu taşıma ve diğer aktif ulaşım modlarıyla entegrasyonu."),
            ("g", "Yeşil Liman / Havalimanı Dönüşümü ", "Açıklama: Operasyonlarda dijitalleşme ve yenilenebilir enerji çözümlerini entegre eden \"yeşil liman / havaliman\" sayısını artırılması."),
            ("h", "Demiryolu Ulaşım Ağının Geliştirilmesi", "Yolcu ve yük taşımacılığındaki paylarını artırmak için demiryolu ağlarını elektriklendirilmesi ve modernizasyonu."),
            ("i", "İstihdam ve Ekonomiye Katkı", "Projenin yeni iş olanakları, tedarik zinciri katkısı ve ekonomik döngüye etkisi."),
            ("j", "Erişilebilirlik ve Toplumsal Kapsayıcılık", "Engelli, yaşlı, çocuk, düşük gelir grupları ve dezavantajlı gruplar için erişim durumu."),
            ("k", "Afetlere Dayanıklı Ulaştırma Altyapısı ve Operasyonel Süreklilik", "Kentsel ulaşım sisteminin afet koşullarına karşı fiziksel altyapı dayanıklılığının artırılmasını, operasyon yönetiminin güçlendirilmesini, AUS tabanlı izlenebilirliğin sağlanmasını, kritik ulaşım ve taşımacılık modlarının sürekliliğini güvence altına almayı ve kent genelinde afet senaryolarına göre hazırlanmış mobilite planlarının uygulanması."),
            ("l", "Batarya, Otonom Araç ve Şarj Altyapısı Teknolojileri ile Elektirifikasyon Altyapısının Geliştirilmesi", "Trafik akışını optimize etmek, tıkanıklığı ve emisyonları azaltmak amacıyla Araçtan Araca (V2V) ve Araçtan Altyapıya (V2I) iletişim teknolojilerinin uygulanması, akıllı ulaşım altyapısı, bağlantılı ve otonom araç teknolojileri, elektrikli araç kullanımının yaygınlaştırılması, batarya teknolojilerinin geliştirilmesi ve şarj altyapısının optimizasyonu."),
            ("m", "Mobility-as-a-Service (MaaS) Sistemlerinin Geliştirilmesi", "Sorunsuz ve düşük karbonlu bir seyahat deneyimi için çok modlu ulaşım seçeneklerini tek bir dijital platforma entegre edilmesi."),
            ("n", "Akıllı ve Sürdürülebilir Ulaşım Yönetim Sistemleri (AUS)", "Akıllı ve Sürdürülebilir Ulaşım Yönetim Sistemleri, şehir içi ulaşımda enerji verimliliği, altyapı izlenebilirliği, lojistik operasyonların dijitalleşmesi, trafik yönetiminin yapay zekâ ile optimize edilmesi, sürdürülebilir mobilite çözümlerinin uygulanması ve otopark yönetiminin gerçek zamanlı sistemlerle etkinleştirilmesi."),
        ]
    },
    "stage3": {
