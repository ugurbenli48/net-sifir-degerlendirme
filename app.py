...
CRITERIA = {
    "stage2": {
        ...
        "criteria": [
            ...
            ("i", "Altyapı verimliliği", "Açıklama: Mevcut altyapının daha verimli kullanılması veya yeni altyapıda verimliliğin artırılması. Ör; demiryolu sinyalizasyon modernizasyonu, limanlarda shore-power, karayolunda adaptif sinyalizasyon uygulamaları, havalimanlarında apron operasyonları optimizasyonu vb."),
